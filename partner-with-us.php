...
<head>
    ...
    <title>Partner With Us | Connect | Boston Living</title>
    <!-- PRELOAD -->
...
<body class="connect partner">
        ...
        <div class="container-fluid">
            <div class="d-flex flex-align-center">
                <div class="col col-12 col-md-6 order-md-2">
                    <img class="lozad img-responsive" data-src="assets/images/connect/partner-with-us.jpeg" alt="">
                </div>
                <div class="col col-12 col-md-6 _pad">
                    <p>Connect</p>
                    <h2 class="bl-title">Partner With Us</h2>
                    <p class="mb-40">If you are good at designing spaces, or organising events, or want to set up a food stall at one of our properties, let us know.</p>
                    <p>If you have something unique you can offer to our community, We would love to partner with you. Click on connect below and fill the form.</p>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <form action="" class="bl-form" method="POST">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label>Detail Your Offering</label>
    ...
    <script>
        ...
        //form submit
        jQuery("#partner-with-submit").click(function() {
            jQuery("#partner-with").validate({
                rules: {
                    fname: "required",
                    lname: "required",
                    email: "required",
                ...
                submitHandler: function(form) {
                    jQuery.ajax({
                        ...
                        success: function(response) {
                            const form = document.forms['partner-with']
                            fetch(scriptURL, {
                                method: 'POST',
                        ...
                        error: function(response) {
                            if (response.responseText !== '') {
                                jQuery(".partner-with-message").fadeIn(400).text(response.responseText);
                            } else {
                                jQuery(".partner-with-message").fadeIn(400).text('Oops! An error occured and your message could not be sent.');
                            }
                        }
                    });
                }
