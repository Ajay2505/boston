...
<head>
    ...
    <title>Reach Out | Connect | Boston Living</title>
    <!-- PRELOAD -->
...
<body class="connect reach-out">
        ...
        <div class="container-fluid">
            <div class="d-flex flex-align-center">
                <div class="col col-12 col-md-6 order-md-2">
                    <img class="lozad img-responsive" data-src="assets/images/connect/reach-out.jpeg" alt="">
                </div>
                <div class="col col-12 col-md-6 _pad">
                    <p>Connect</p>
                    <h2 class="bl-title">Reach Out</h2>
                    <p class="mb-40">This is a general form. Click on connect below and let us know if you have any message, query or feedback.</p>
                    <p>The relevant person from our team will reach out to you as soon as possible.</p>
    ...
    <script>
        ...
        //form submit
        jQuery("#reach-out-submit").click(function() {
            jQuery("#reach-out").validate({
                rules: {
                    fname: "required",
                    lname: "required",
                    email: "required",
                ...
                submitHandler: function(form) {
                    jQuery.ajax({
                        ...
                        success: function(response) {
                            const form = document.forms['reach-out']
                        ...
                        error: function(response) {
                            if (response.responseText !== '') {
                                jQuery(".reach-out-message").fadeIn(400).text(response.responseText);
                            } else {
                                jQuery(".reach-out-message").fadeIn(400).text('Oops! An error occured and your message could not be sent.');
                            }
                        }
                    });
                }
