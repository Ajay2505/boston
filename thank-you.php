...
<head>
    ...
    <title>Thank You | Boston Living</title>
    <!-- PRELOAD -->
        ...
        <div class="container py-4r">
            <div class="d-flex flex-align-center">
                <div class="col col-12 col-md-6">
                    <img src="assets/images/thank-you.svg" alt="" class="img-responsive _greetings">
                </div>
                <div class="col col-12 col-md-6">
                    <div class="_info">
                        <h3 class="bl--title">We have received your enquiry.</h3>
